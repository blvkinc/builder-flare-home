    ...
    >
      ...
      <div className="relative aspect-square overflow-hidden bg-muted">
        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <Button variant="default" size="sm" asChild className="backdrop-blur-sm">
      ...
      <div className="p-5 space-y-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <Button variant="outline" size="sm" className="text-xs border-neon/50 hover:border-neon hover:bg-neon/10">
            Buy Now
          </Button>
        </div>
      </div>
