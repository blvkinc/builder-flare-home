...
export default function Auth() {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      const success = await login(signInData.email, signInData.password, signInData.role);
      if (success) {
        toast({
          title: "Welcome back!",
                  ...
                  <form onSubmit={handleSignIn} className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <RadioGroup
                        ...
                        onValueChange={(value: UserRole) => setSignInData(prev => ({ ...prev, role: value }))}
                        className="flex space-x-6"
                      >
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="buyer" id="signin-buyer" />
                          <Label htmlFor="signin-buyer" className="flex items-center space-x-2 cursor-pointer">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="signin-artist" className="flex items-center space-x-2 cursor-pointer">
                    ...
                    <div className="space-y-3">
                      ...
                      >
                        <div className="flex items-start space-x-3 p-3 border border-border rounded-lg">
                          <RadioGroupItem value="buyer" id="signup-buyer" className="mt-1" />
                          <div className="flex-1">
                            <Label htmlFor="signup-buyer" className="flex items-center space-x-2 cursor-pointer">
                              <ShoppingBag className="w-4 h-4" />
                        ...
                        <div className="flex items-start space-x-3 p-3 border border-border rounded-lg">
                          <RadioGroupItem value="artist" id="signup-artist" className="mt-1" />
                          <div className="flex-1">
                            <Label htmlFor="signup-artist" className="flex items-center space-x-2 cursor-pointer">
                              <Palette className="w-4 h-4" />
