...
const allArtworks = [
  ...
  },
  {
    ...
    artist: "HoloVision",
    price: 6.3,
    imageUrl: "https://images.unsplash.com/photo-1614630482437-8e5e7e5ad725?w=400&h=400&fit=crop",
    likes: 567,
    views: 2890,
    category: "Animation",
...
const categories = ["All", "Illustration", "3D", "Animation", "Concept Art", "Abstract"];
const sortOptions = [
...
export default function Explore() {
  ...
  const allTags = Array.from(new Set(allArtworks.flatMap(artwork => artwork.tags)));
  ...
  const filteredArtworks = allArtworks
    .filter(artwork => {
      ...
      const matchesTags = selectedTags.length === 0 || selectedTags.some(tag => artwork.tags.includes(tag));
      ...
      <div className="min-h-screen py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8 space-y-4">
              ...
              <Sheet>
                <SheetTrigger asChild>
                  <Button variant="outline" size="sm">
                    ...
                    Filters
                    {(selectedTags.length > 0 || priceRange[0] > 0 || priceRange[1] < 10) && (
                      <Badge variant="secondary" className="ml-2 h-5 w-5 rounded-full p-0 flex items-center justify-center">
                        {selectedTags.length + (priceRange[0] > 0 || priceRange[1] < 10 ? 1 : 0)}
                      </Badge>
                    )}
                  </Button>
                </SheetTrigger>
            ...
            {/* Active Filters */}
            {(selectedTags.length > 0 || selectedCategory !== "All" || priceRange[0] > 0 || priceRange[1] < 10) && (
              <div className="flex flex-wrap items-center gap-2">
                ...
                {(priceRange[0] > 0 || priceRange[1] < 10) && (
                  <Badge variant="secondary" className="cursor-pointer" onClick={() => setPriceRange([0, 10])}>
