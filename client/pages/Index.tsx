  ...
  return (
    <Layout>
      ...
      <section
        ...
        style={{
          backgroundImage: `radial-gradient(circle at 30% 20%, rgba(64, 200, 224, 0.12) 0%, transparent 50%),
                           radial-gradient(circle at 70% 80%, rgba(64, 200, 224, 0.08) 0%, transparent 50%),
                           radial-gradient(circle at 50% 50%, rgba(45, 180, 210, 0.03) 0%, transparent 70%)`,
        }}
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <div className="space-y-8">
            ...
            <div className="flex justify-center mb-6">
              <Badge
                variant="outline"
                className="px-6 py-2 border-neon text-neon bg-neon/5 text-sm font-medium"
              >
            ...
            <div className="space-y-6">
              ...
              >
                Discover, collect, and trade authentic digital artworks from
                verified human creators.
                <span className="text-neon font-medium">
                  {" "}
                  Every piece is 100% human-made.
                </span>
              </p>
            </div>
            ...
            >
              <Button
                asChild
                size="lg"
                className="bg-neon text-black hover:bg-neon/90 font-semibold px-8 py-4 text-lg group"
              >
                <Link to="/auth">
                  Join The Movement
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="px-8 py-4 text-lg border-neon/50 hover:border-neon"
              >
                <Link to="/explore">
          ...
          >
            <div className="group text-center space-y-6 p-8 rounded-2xl border border-border/50 bg-card/50 hover:bg-card transition-all duration-500 hover:scale-105">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Every artwork is verified to be 100% human-created. No AI, no
                exceptions. Pure human creativity.
              </p>
            </div>
            ...
            <div className="group text-center space-y-6 p-8 rounded-2xl border border-border/50 bg-card/50 hover:bg-card transition-all duration-500 hover:scale-105">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Rigorous verification process ensures only authentic human
                artists join our platform
              </p>
            </div>
            ...
            <div className="group text-center space-y-6 p-8 rounded-2xl border border-border/50 bg-card/50 hover:bg-card transition-all duration-500 hover:scale-105">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Artists keep 90% of sales with transparent, low fees that
            ...
            <div className="group text-center space-y-6 p-8 rounded-2xl border border-border/50 bg-card/50 hover:bg-card transition-all duration-500 hover:scale-105">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Built by artists, for artists. Your success is our mission and
                priority
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Curated digital masterpieces from our most talented verified human
              artists
            </p>
          </div>
          ...
          <div className="text-center mt-16">
            <Button
              ...
              variant="outline"
              size="lg"
              className="group border-neon/50 hover:border-neon"
            >
              <Link to="/explore">
      ...
      <section className="py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-background via-neon/5 to-background">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed mb-8">
            In a world flooded with AI-generated content, Avt stands as a
            sanctuary for authentic human creativity. Every artist is verified,
            every artwork is inspected, and every piece carries the
            irreplaceable touch of human imagination.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="text-center">
              ...
              <div className="text-muted-foreground">
                Every submission is personally reviewed by our human curators
              </div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-neon mb-2">
              ...
              <div className="text-muted-foreground">
                Multi-step process to verify the human identity of each creator
              </div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-neon mb-2">
              ...
              <div className="text-muted-foreground">
                Immediate ban for any AI-generated content discovered
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="border-t border-border bg-muted/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground">
                The future of digital art marketplace. Authentic, human-created,
                artist-first.
              </p>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <Link
                  to="/explore"
                  className="block text-muted-foreground hover:text-neon transition-colors"
                >
                  Explore Human Art
                </Link>
                <Link
          ...
          <div className="border-t border-border mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center">
            <div className="text-sm text-muted-foreground">
              © 2024 Avt. All rights reserved. Proudly supporting human
              creativity.
            </div>
            <div className="flex items-center space-x-4 mt-4 sm:mt-0">
              <Badge
                variant="outline"
                className="border-neon/30 text-neon text-xs"
              >
